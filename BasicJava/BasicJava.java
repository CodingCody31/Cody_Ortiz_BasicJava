...
public class BasicJava{
    ...
    /*public ArrayList<Integer> oddArr(int start, int end ){
    ...
    /*public int greaterY(int[] x, int y){
        int count = 0; 
